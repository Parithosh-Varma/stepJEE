  ...
  return (
    <div className="rounded-xl border border-[var(--ion-border)] bg-white shadow-[var(--ion-shadow)] dark:bg-stone-900">
        ...
        {displayedSteps.map((step, index) => {
          ...
          return (
            <div
              ...
              className={`flex gap-3 px-4 py-3 animate-fade-in-up ${staggerClass} sm:px-5 sm:py-3.5 ${
      ...
      {revealMode && revealedUpTo < steps.length && (
        <div className="flex items-center justify-center gap-4 border-t border-[var(--ion-border-light)] px-4 py-4 dark:border-[var(--ion-border)]">
          <button
            type="button"
            onClick={revealNext}
            className="inline-flex items-center gap-1.5 rounded-lg bg-stone-950 px-4 py-2 text-xs font-semibold text-white transition-all hover:bg-stone-800 active:scale-[0.97] dark:bg-stone-100 dark:text-stone-950 dark:hover:bg-stone-300"
          >
            Reveal step {revealedUpTo + 1}
            <svg className="h-3.5 w-3.5" viewBox="0 0 24 24" fill="none" stroke="currentColor" strokeWidth="2.5" strokeLinecap="round"><path d="M9 18l6-6-6-6"/></svg>
          </button>
          <button
            type="button"
            onClick={revealAll}
            className="rounded-lg border border-stone-200 bg-white px-3 py-2 text-[11px] font-medium text-stone-600 transition-all hover:bg-stone-50 active:scale-[0.97] dark:border-stone-700 dark:bg-stone-800 dark:text-stone-400 dark:hover:bg-stone-700"
          >
            Reveal all
          </button>
        </div>
      ...
      {steps.length > 1 && (
        <div className="flex items-center justify-between border-t border-[var(--ion-border-light)] px-4 py-2.5 dark:border-[var(--ion-border)] sm:px-5">
          ...
          <button
            ...
            className="rounded-lg border border-stone-200 bg-white px-2.5 py-1.5 text-[11px] font-medium text-stone-600 transition-all hover:bg-stone-50 active:scale-[0.97] dark:border-stone-700 dark:bg-stone-800 dark:text-stone-400 dark:hover:bg-stone-700"
          >
      ...
      {/* Verification note */}
      <div className="rounded-b-xl border-t border-[var(--ion-border-light)] bg-amber-50 px-4 py-2.5 text-[11px] leading-relaxed text-amber-800 dark:border-[var(--ion-border)] dark:bg-amber-900/20 dark:text-amber-300">
