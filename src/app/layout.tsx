  ...
  return (
    <html lang="en" suppressHydrationWarning>
      ...
      <body className="min-h-screen bg-stone-50 text-stone-950 antialiased selection:bg-stone-950 selection:text-white dark:bg-stone-950 dark:text-stone-100 dark:selection:bg-stone-100 dark:selection:text-stone-950">
        <Script src="/js/katex.min.js" strategy="beforeInteractive" />
        <div aria-hidden="true" style={{ display: "none" }} dangerouslySetInnerHTML={{
          __html: `<script>try{if(localStorage.getItem('stepjee-theme')==='dark'){document.documentElement.classList.add('dark')}}catch(e){}</script>`,
        }} />
        {children}
      </body>
    </html>
