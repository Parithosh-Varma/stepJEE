...
import { PHYSICS_TOPICS, topicSlug } from "@/lib/topics";
    ...
    <main className="min-h-screen bg-stone-50 text-stone-950 antialiased dark:bg-stone-950 dark:text-stone-100">
      <header className="border-b border-stone-200/80 bg-white dark:border-stone-800 dark:bg-stone-900">
        <div className="mx-auto flex h-12 max-w-4xl items-center justify-between px-4 sm:px-6">
          <div className="flex items-center gap-2">
            ...
            <span className="text-sm font-medium text-stone-900 dark:text-stone-100">Physics</span>
          </div>
        </div>
      </header>
      ...
      <div className="mx-auto max-w-4xl px-4 py-6 sm:px-6 sm:py-8">
        <header className="mb-5">
          <h1 className="text-lg font-bold text-stone-950 dark:text-stone-100">Physics Topics</h1>
          <p className="mt-0.5 text-xs text-stone-500 dark:text-stone-400">25 JEE syllabus topics</p>
        </header>
